...
aliases:
 - /2022/02/22/future-1.24.0-forwarding-rng-state-also-for-stand-alone-futures/
categories:
 - R
 - package
 - future
...
<center>
  <img src="resources/xkcd_221-random_number.png" alt="A one-box XKCD comic with the following handwritten code:
