...
<div style="padding: 2ex; float: right;"/>
 <center>
   <img src="resources/three_in_chinese.gif" alt="Three strokes writing three in Chinese"/>
 </center>
</div>
...
![Animation of a one-line, green-blocks cli progress bar in the terminal growing from 0% to 100% with an ETA estimate at the end](resources/handler_cli-default-slow_sum.svg)
...
![Animation of a one-line, yellow-starts cli progress bar in the terminal growing from 0% to 100% with an ETA estimate at the end](resources/handler_cli-default-slow_sum-yellow-starts.svg)
...
![Animation of a one-line, green-blocks cli progress bar in the terminal growing from 0% to 100% with an ETA estimate at the end](resources/handler_cli-default.svg)
...
![Animation of a one-line, text-based red-hearts progress bar in the terminal growing from 0% to 100%](resources/handler_txtprogressbar-custom-hearts.svg)
