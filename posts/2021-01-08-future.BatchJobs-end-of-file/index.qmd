...
aliases:
 - /2021/01/08/future.batchjobs-end-of-life-announcement/
categories:
 - R
 - package
 - future.BatchJobs
...
<div style="width: 40%; margin: 2ex; float: right;"/>
 <center>
   <img src="resources/sign_out_of_service_do_not_use.png" alt="Sign: Out of Service - Do not use!" style="width: 100%;"/>
 </center>
</div>
