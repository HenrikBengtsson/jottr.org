...
<small>(Image credits: Hadley Wickham and Greg Swinehart for the
ggplot2 logo and balloon wall; Dan LaBar for the future logo. The
future balloon wall was inspired by ggplot2’s recent real-world
version and generated with ChatGPT.)</small>

</figcaption>
</figure>

The **[future]** package turns ten years old today. I released version
0.6.0 to CRAN on June 19, 2015, just days before I presented it at
[useR! 2016]. I had no idea adoption would snowball the way it has. It's
been an exciting, fun journey, and the best part has been you - the
users and developers who shaped the futureverse through questions,
discussions, bug reports, and feature requests. Thank you!
